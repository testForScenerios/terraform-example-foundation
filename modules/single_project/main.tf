...
module "project" {
  ...
  folder_id                   = var.project_parent_folder_id

  svpc_host_project_id        = var.svpc_host_project_id
  //shared_vpc_subnets   = data.google_compute_network.shared_vpc[0].subnetworks_self_links # Optional: To enable subnetting, replace to "module.networking_project.subnetwork_self_link"
