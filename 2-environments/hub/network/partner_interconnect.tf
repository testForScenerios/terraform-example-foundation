...
module "partner_interconnect" {
  ...
  region1_router1_name           = module.nethub_shared_vpc[0].region1_router1.router.name
  region1_interconnect1_location = "las-zone1-770"
  region1_router2_name           = module.nethub_shared_vpc[0].region1_router2.router.name
  region1_interconnect2_location = "las-zone1-770"

  region2                        = var.default_region2
  region2_router1_name           = module.nethub_shared_vpc[0].region2_router1.router.name
  region2_interconnect1_location = "lax-zone2-19"
  region2_router2_name           = module.nethub_shared_vpc[0].region2_router2.router.name
